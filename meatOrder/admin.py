...
class MeatOrderAdmin(admin.ModelAdmin):
    list_display = ('order_number', 'product_name', 'quantity', 'unit_price', 'subtotal', 'remark', 'supplier_name',
                    'procurement_staff')
    list_display_links = ('product_name',)
    fields = ('order_number', 'product_name', 'quantity', 'unit_price', 'subtotal', 'remark', 'supplier_name',
              'procurement_staff')
